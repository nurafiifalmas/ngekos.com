        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <a href="shop-single.html" class="h3 text-decoration-none text-dark bold">Apakah Anda pemilik kos? </a>
                </div>
                    <a href="shop-single.html" class="h4 text-decoration-none text-dark">Segera promosikan kos Anda! </a>
            </div>
